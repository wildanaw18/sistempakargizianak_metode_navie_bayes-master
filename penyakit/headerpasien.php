                ...
                <div class="main-sidebar">
                    ...
                    <aside id="sidebar-wrapper">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="active"><a class="nav-link" href="../penyakit/indexpasien.php"><i class="fa fa-thermometer-empty" aria-hidden="true"></i><span>Penyakit</span></a></li>
                            <li><a class="nav-link" href="../gejala/indexpasien.php"><i class="fas fa-procedures"></i><span>Gejala</span></a></li>
                            <li><a class="nav-link" href="../diagnosa/indexpasien.php"><i class="fas fa-stethoscope"></i><span>Diagnosa</span></a></li>
