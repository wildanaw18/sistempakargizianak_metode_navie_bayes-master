                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action mt-3">
                            ...
                            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Tambah Pasien</button>
...
if (isset($_POST['submit'])) {
    ...
    if ($row > 0) {
        ...
        $save = mysqli_query($con, "INSERT INTO pasien VALUES ('', '$idadmin', '$namapasien', '$username', '$jk', '$usia tahun' ,  '$password' )") or die(mysqli_error($con));
