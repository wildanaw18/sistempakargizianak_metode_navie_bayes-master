                ...
                <nav class="navbar navbar-expand-lg main-navbar">
                    ...
                    <ul class="navbar-nav navbar-right">
                        ...
                        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                                ...
                                <div class="d-sm-none d-lg-inline-block">Selamat Datang, <?= $_SESSION['usernamepasien']; ?></div>
                            </a>
                        ...
                        <ul class="sidebar-menu">
                            <li>
                                <div class="sidebar-brand">
                                    ...
                                    <a href="indexpasien.php">Sistem Pakar</a>
                                </div>

                            </li>
                            <li><a class="nav-link" href="../Dashboard/indexpasien.php"><i class="fas fa-home"></i> <span>Home</span></a></li>
                            </li>
                            <li><a class="nav-link" href="../pasien/indexpasien.php"><i class="fas fa-procedures"></i><span>Pasien</span></a></li>

                            <li><a class="nav-link" href="../penyakit/indexpasien.php"><i class="fa fa-thermometer-empty" aria-hidden="true"></i><span>Penyakit</span></a></li>
                            <li><a class="nav-link" href="../gejala/indexpasien.php"><i class="fas fa-procedures"></i><span>Gejala</span></a></li>
                            <li class="active"><a class="nav-link" href="../diagnosa/indexpasien.php"><i class="fas fa-stethoscope"></i><span>Diagnosa</span></a></li>
