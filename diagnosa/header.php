...
if (!isset($_SESSION['username']) && !isset($_SESSION['usernameuser'])) {
                ...
                <div class="main-sidebar">
                    ...
                    <aside id="sidebar-wrapper">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="active"><a class="nav-link" href="../diagnosa/index.php"><i class="fas fa-stethoscope"></i><span>Diagnosa</span></a></li>
